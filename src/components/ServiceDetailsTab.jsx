...
const ServiceDetailsTab = () => {
  ...
  const helps = [
    {
      ...
      items:['Email management', 'Calendar scheduling', 'Document organization', 'Customer response management']
    },
    {
      title:`Social Media and Marketing`,
      desc:"84% of businesses and brands need help with digital marketing.",
      items:['Content creation', 'Social media management', 'Marketing campaign execution', ]
    },
    {
      title:`Customer Service`,
      desc:"71% of businesses and personal brands require assistance with online customer engagement.",
      items:['Customer inquiry responses', 'Follow-up communications', 'Client relationship management']
    },
  ...
  return (
    <section className="dark:bg-light-blue min-h-[400px] flex flex-col gap-5 justify-between items-center px-10 py-15 w-full">
      <div>
      ...
      <div className="w-full">
        <div className="md:flex md:flex-col gap-10 w-full dark:bg-purple p-10 rounded-lg ring-1 ring-ftvgrey-400">
            ...
            {helps.map((tab, index) => (
              <li key={index} className="w-4/12 ">
                <button
                  ...
                  className={`inline-flex items-center  rounded-lg w-full flex-col justify-center text-base bg-blue-700 dark:bg-white border-t-4 border-ftvgrey-500  dark:border-t-4 cursor-pointer dark:border-ftvblue-500 gap-4 ring-1 dark:ring-ftvgrey-400 ring-ftvgrey-400  ${
                    activeTab === index
                      ? "text-ftvblue-400 bg-blue-700 dark:bg-ftvblue-50 h-fit  border-t-4 border-yellow  dark:border-t-4 dark:border-yellow  "
                  ...
                  <span className=" dark:bg-ftvgreen-25 bg-ftvgreen-25 w-full px-4 py-3 rounded-lg">
                    {tab.title}
                  </span>
                </button>
              </li>
          ...
          <div className="tab-content w-full ">
            <div className=" flex justify-between p-6  text-medium text-gray-500 dark:text-gray-400  rounded-lg w-full">
                <div className="w-6/12">
                  ...
                  <ul className="w-full flex flex-col gap-4 mb-7">
                    {
                      helps[activeTab].items.map((item, ii)=>(
                        <li key={ii} className="flex gap-3 items-center text-lg text-light-blue">
                          <span className="fa fa-check text-light-blue text-2xl"></span>
                          {item}
                        </li>
                      ))
                    }
                  ...
                  <button type="button" className="text-purple rounded-lg border border-white bg-light hover:bg-light-blue cursor-pointer py-3 px-5 w-5/12 ">
                    Get started
                  </button>
                </div>
                <div className="w-5/12 h-full">
                  <img src="/work.svg" className="ring-1 ring-ftvgrey-400 rounded-lg w-full h-full shadow-lg shadow-ftvblue-200" alt="administrative tasks"
                  />
              </div>
            </div>
          </div>
