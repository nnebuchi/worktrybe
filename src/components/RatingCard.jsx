...
const RatingCard = () => {
  return (
    <Link
      to="/"
      className="w-[27%] h-30 bg-pink hover:dark:bg-ftvgrey-50 dark:ring-ftvgrey-500 dark:ring-1 rounded-lg flex flex-col gap-3 justify-evenly items-between px-5 category-card">
