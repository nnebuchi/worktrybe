...
const RatingCard = () => {
  return (
    <Link
      to="/"
      className="w-[27%] h-30 dark:bg-ftvsky-200 hover:dark:bg-ftvsky-100 dark:ring-ftvblue-500 dark:ring-1 rounded-lg flex flex-col gap-3 justify-evenly items-between px-5 category-card">
