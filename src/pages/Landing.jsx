...
const Landing = () => {
  return (
    <>
      <Navbar />
      <section className="bg-white dark:bg-ftvwine-25 pt-20 b">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          <h1 className="mb-4 text-4xl font-extrabold tracking-wide leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-ftvwine-500">
          ...
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a
              href="#"
              className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-ftvwine-400 rounded-lg bg-primary-700 focus:ring-4 focus:ring-ftvwine-400 dark:focus:ring-ftvwine-400 hover">
              Find a VA
              <svg
          ...
          <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
            <span className="font-bold text-ftvwine-500 capitalize text-xl">
              trusted by
            </span>
      ...
      <section className="bg-white dark:bg-ftvsky-500 flex flex-col justify-center items-center  min-h-[400px] py-15 px-10 ">
        ...
        <div className="rounded-lg bg-white dark:bg-ftvblue-500 min-h-100 w-full mx-auto flex justify-evenly items-center flex-wrap py-7">
          <RatingCard />
          <RatingCard />
          <RatingCard />
          <RatingCard />
      ...
      <section className=" min-h-[300px] py-15 px-10 bg-ftvblue-500 flex justify-center items-center">
        <div className="flex flex-col justify-center items-center w-full">
          <h1 className="mb-4 text-3xl tracking-wide font-bold dark:text-ftvsky-500  text-center w-10/12">
          ...
          <button
            type="button"
            className="text-ftvsky-500 bg-blue-700 hover:bg-blue-800 focus:ring-1 focus:outline-none focus:ring-ftvgrey-400 font-medium rounded-lg py-3 px-5 text-center ring-1 ring-ftvsky-500 dark:bg-transparent  dark:hover:bg-ftvblue-600 dark:focus:ring-ftvgrey-400 cursor-pointer w-4/12 mt-5 text-xl">
            Book a Call
          </button>
        </div>
      </section>
