      ...
      <section className="bg-white dark:bg-ftvblue-25 pt-20 b">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a
              href="#"
              className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-ftvblue-400 rounded-lg bg-primary-700 focus:ring-4 focus:ring-ftvblue-400 dark:focus:ring-ftvblue-400 hover">
              Find a VA
              <svg
          ...
          <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
            <span className="font-bold text-ftvblue-500 capitalize text-xl">
              trusted by
            </span>
          ...
          <form className="flex items-center max-w-sm mx-auto me-3 w-7/12">
            ...
            <div className="relative w-full ">
              ...
              <input
                type="text"
                id="simple-search"
                className="bg-ftvgrey-50 border border-ftvgrey-300 text-ftvgrey-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-ftvblue-25 focus:dark:bg-ftvblue-400  dark:border-ftvgrey-300 dark:placeholder-ftvgrey-200 dark:text-white dark:focus:ring-none dark:focus:border-none outline-none h-12 "
            ...
            <button
              type="submit"
              className="p-3 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-ftvblue-500 hover:bg-blue-800 focus:ring-none focus:outline-none focus:ring-blue-300 dark:bg-ftvblue-500 dark:hover:bg-ftvgreen-500 dark:focus:ring-ftvgreen-500 ">
              <i className="fa fa-filter"></i>
              <span className="sr-only">Search</span>
            </button>
          </form>
        </div>
        <div className="rounded-lg bg-white dark:bg-linear-65 from-ftvblue-500 via-ftvpurple-500 to-ftvgreen-400 min-h-100 w-full mx-auto flex justify-evenly items-center flex-wrap py-7">
          <RatingCard />
          <RatingCard />
          <RatingCard />
          <RatingCard />
