...
const Landing = () => {
  return (
    <>
      ...
      <section className="dark:bg-white bg-white min-h-[400px] flex flex-col justify-between items-center px-10 py-15">
        <div>
          <h1 className="mb-4 text-3xl tracking-tight font-bold text-gray-900 dark:text-ftvblue-500 capitalize text-center">
            How it works
          </h1>
          <p className="mb-4 text-ftvblue-400 text-lg">
            Hire an assitant in four steps, reclaim your time and focus on what
            matters.
          </p>
        </div>
        <div>
